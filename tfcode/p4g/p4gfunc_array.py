...
import p4g.p4g_array as p4ga
from groupy.gfunc.gfuncarray import GFuncArray


class P4GFuncArray(GFuncArray):
    ...
    def __init__(self, v, umin=None, umax=None, vmin=None, vmax=None):
        ...
        i2g = p4ga.meshgrid(
            m=p4ga.m_range(),
            r=p4ga.r_range(0, 4),
            u=p4ga.u_range(self.umin, self.umax + 1),
            v=p4ga.v_range(self.vmin, self.vmax + 1)
        )
        ...
        super(P4GFuncArray, self).__init__(v=v, i2g=i2g)
